#ifndef STALMATE_H_INCLUDED
#define STALMATE_H_INCLUDED
#include "functions.h"
#include "checkmate.h"
//check for stalemate only
...
int mate_check_s(struct board_str a[8][8],char kind,char colors){
    int ret;
...
//-------------------------------------------------------
int check_stalemate_black(struct board_str a[8][8]){
    int result=0;
    int a1,b1;
                        for(int i=0;i<8;i++){
                            for(int j=0;j<8;j++){
                                ...
                                switch(a[i][j].print){
                                    ...
                                    case('Q'):
                                        ...
                                        break;
                                    case('P'):
                                        eat=pawn_eat_k(f_ch,f_num,to_ch,to_num,a[i][j].color,a[k][m].color);
                                ...
                                if(a1&& b1){
                                        char sw1=a[i][j].print;
                                        char sw2 =a[k][m].print;
                                        a[k][m].print=sw1;
                                        a[i][j].print=' ';
                                        int check = mate_check_s(a,'K','b');
                                        if(check==1){
                                            result=1;
                                            a[i][j].print=sw1;
                                            a[k][m].print=sw2;
...
//----------------------------------------------------------------------------
int check_stalemate_white(struct board_str a[8][8]){
    int result=0;
    int a1,b1;
                        for(int i=0;i<8;i++){
                            for(int j=0;j<8;j++){
